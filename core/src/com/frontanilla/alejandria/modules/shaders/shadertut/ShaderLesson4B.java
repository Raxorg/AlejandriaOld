...
public class ShaderLesson4B implements ApplicationListener {
    ...
    public void create() {
        ...
        Texture tex1 = new Texture(Gdx.files.internal("data/dirt.png"));
        Texture mask = new Texture(Gdx.files.internal("data/mask.png"));
        ...
        shader = new ShaderProgram(VERT, FRAG2);
        // shader = new ShaderProgram(VERT, FRAG2); Using file instead of a big String
