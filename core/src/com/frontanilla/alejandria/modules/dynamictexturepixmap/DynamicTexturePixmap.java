package com.frontanilla.alejandria.modules.dynamictexturepixmap;
...
public class DynamicTexturePixmap extends ApplicationAdapter {
    ...
    public void create() {
        ...
        outline = new Texture("dynamictexturepixmap/smiley_outline.png");
        color = new Texture("dynamictexturepixmap/smiley_color.png");
        ...
        vertexShader = Gdx.files.internal("dynamictexturepixmap/vertex.glsl");
        fragmentShader = Gdx.files.internal("dynamictexturepixmap/fragment.glsl");
        ...
        Pixmap pixmap = new Pixmap(Gdx.graphics.getWidth(),
                Gdx.graphics.getHeight(), Pixmap.Format.Alpha);
        ...
        drawable = new DrawablePixmap(pixmap, 1);
